...
echo "==============================================="
echo "  Bắt đầu cài đặt CareVL (Nhánh Main - Stable) "
echo "==============================================="
...
# 3. Clone và setup
echo "Đang tải mã nguồn từ nhánh main..."
git clone -b main https://github.com/DigitalVersion/vinhlong-health-record.git carevl-app || true
cd carevl-app
